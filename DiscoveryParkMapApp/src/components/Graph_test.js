...
route.addNode('B10', {
  B20: calculateDistance(B10.latitude, B10.longitude, B20.latitude, B20.longitude),
  B140_ac1: calculateDistance(B10.latitude, B10.longitude, B140_ac1.latitude, B140_ac1.longitude),
  B142_ac1: calculateDistance(B10.latitude, B10.longitude, B142_ac1.latitude, B142_ac1.longitude),
});

// Reverse relations
route.addNode('B00', { E1: calculateDistance(B00.latitude, B00.longitude, E1.latitude, E1.longitude) });
route.addNode('B10', { B00: calculateDistance(B10.latitude, B10.longitude, B00.latitude, B00.longitude) });
route.addNode('B20', { B10: calculateDistance(B20.latitude, B20.longitude, B10.latitude, B10.longitude) });
route.addNode('B140_ac1', { B10: calculateDistance(B140_ac1.latitude, B140_ac1.longitude, B10.latitude, B10.longitude) });
route.addNode('B142_ac1', { B10: calculateDistance(B142_ac1.latitude, B142_ac1.longitude, B10.latitude, B10.longitude) });
//route.addNode('f', { g: calculateDistance(f.latitude, f.longitude, g.latitude, g.longitude) });

console.log(route.path('B20', 'B140'));
